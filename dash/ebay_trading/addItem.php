...
require_once 'ebay_cat.php';
$appid = "";
$result=geteBayCategories("http://open.api.ebay.com/Shopping?callname=GetCategoryInfo&appid=$appid&siteid=0&CategoryID=-1&version=729&IncludeSelector=ChildCategories");
...
function getAddItem($addTitle, $addCatID, $addSPrice, $addPicture, $addDesc) {
  ...
  $xmlRequest .= "<PayPalEmailAddress>isaiahnwu@gmail.com</PayPalEmailAddress>";
