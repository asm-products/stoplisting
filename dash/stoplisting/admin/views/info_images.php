...
<div class="row">
  ...
  if(isset($_SESSION['msg']))
  {
    ...
    <section class="panel">
      <header class="panel-heading"> Need for Information Images List <span class="tools pull-right"> <a href="javascript:;" class="fa fa-chevron-down"></a> <a href="javascript:;" class="fa fa-cog"></a> <a href="javascript:;" class="fa fa-times"></a> </span> </header>
