...
/*	$cl_name	=	$_REQUEST["name"];
	...
	$category_data2	=	mysql_query("select id,name from tbl_image_cat") or die(mysql_error());
	$category_data3	=	mysql_query("select id,name from tbl_image_cat") or die(mysql_error());
*/
}
//	$image_data	=	"select id,name from tbl_image_cat";
	$sql=$db_fun->getAllUsers();
?>