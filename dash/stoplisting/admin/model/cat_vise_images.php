<?php 
	...
	$sql	=	"select img.*,img.id as img_id,img.name as img_name,cat.name as cat_name from tbl_image as img left join tbl_image_cat as cat on img.cat_id=cat.id order by img.id asc";
