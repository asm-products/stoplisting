...
public class WPricePreferenceActivity extends Activity implements
		OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wprice_preference_screen);
		...
		webView.loadUrl("file:///android_asset/local/price_preference.html");
	}
