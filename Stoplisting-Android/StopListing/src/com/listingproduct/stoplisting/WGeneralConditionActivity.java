...
public class WGeneralConditionActivity extends Activity implements
		OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wgeneral_condition_screen);
		...
		webView.loadUrl("file:///android_asset/local/general_condition.html");
	}
