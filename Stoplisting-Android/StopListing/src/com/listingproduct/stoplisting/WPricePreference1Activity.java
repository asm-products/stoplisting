...
public class WPricePreference1Activity extends Activity implements
		OnClickListener {

	EditText contentEt;
	private static final String FIELD = "price_preference";
	private static final String TITLE_MSG = "Please wait";
	private static final String RETRIEVING_MSG = "Retrieving your price preference information...";
	private static final String UPDATING_MSG = "Updating your price preference information...";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wprice_preference_screen1);
	...
	AnyTaskCallback updateInfoTaskCallBack = new AnyTaskCallback() {
		...
		public void onResult(boolean success, String result) {
			...
			if (!strMessage.isEmpty()) {
				Toast.makeText(WPricePreference1Activity.this, strMessage,
