...
public class ReListItemTask extends AsyncTask<String, Void, String> {
	...
	public ReListItemTask(Context context, AnyTaskCallback callback, int userId,
			String itemId) {
		mContext = context;
		mCallback = callback;
		mProgTitle = "Please wait";
		mProgMsg = "Relisting Item...";
		...
		nameValuePairs.add(new BasicNameValuePair("field", "relist"));
			...
			if (mSuccess) {
				...
				try {
					...
					if (strStatus.equals("200")) {
						strMessage = "Successfully ReListed Your Item.";
					} else {
						strMessage = "Item Relisting Failure.";
					}
