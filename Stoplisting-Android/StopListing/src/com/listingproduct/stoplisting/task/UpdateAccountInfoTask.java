...
public class UpdateAccountInfoTask {
	...
	String mTaskSuccessMsg = "Successfully Updated.";
	String mTaskFailureMsg = "Updating Failure. Please try again later.";
	String Tag = "UpdateAccountInfoTask";

	public UpdateAccountInfoTask(Context context, int liveFinderId) {
