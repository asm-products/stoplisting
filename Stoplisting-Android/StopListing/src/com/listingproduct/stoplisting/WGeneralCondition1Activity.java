...
import com.listingproduct.stoplisting.ListingSettingsActivity.TemplateItemAdapter;
...
public class WGeneralCondition1Activity extends Activity implements
		OnClickListener {

	EditText contentEt;
	private static final String FIELD = "general_condition";
	private static final String TITLE_MSG = "Please wait";
	private static final String RETRIEVING_MSG = "Retrieving your general condition information...";
	private static final String UPDATING_MSG = "Updating your general condition information...";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wgeneral_condition_screen1);
	...
	AnyTaskCallback updateInfoTaskCallBack = new AnyTaskCallback() {
		...
		public void onResult(boolean success, String result) {
			...
			if (!strMessage.isEmpty()) {
				Toast.makeText(WGeneralCondition1Activity.this, strMessage,
